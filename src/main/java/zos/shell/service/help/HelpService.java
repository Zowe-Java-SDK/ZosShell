...
public class HelpService {
    ...
    private static final Map<String, Map.Entry<String, String>> HELP = Map.ofEntries(
            ...
            Map.entry("count", Map.entry("count <>arg", "number of members or datasets in PWD, arg = -m | -d | --members | --datasets")),
            ...
            Map.entry("search", Map.entry("search <arg>", "arg=string; search previous command contents")),
            ...
            Map.entry("submit", Map.entry("submit <arg>", "arg=member or dataset(member); submit")),
    ...
    private static final Map<String, Map.Entry<String, String>> HELP_WITH_ABBREVIATIONS = Map.ofEntries(
            ...
            Map.entry("d", Map.entry("d | download <arg1> <arg2>", "arg1=member, dataset(member) or sequential dataset; download to \\downloadpath\\$HOSTNAME\\pwd or \\downloadpath\\$HOSTNAME\\SEQUENTIAL_DATASET; arg2=optional or -b for binary download")),
