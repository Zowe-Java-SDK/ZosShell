...
public class SaveService {
    ...
    public SaveService(final DsnWrite dsnWrite, final CheckSumService checkSumService, final long timeout) {
    ...
    public ResponseStatus save(final String dataset, final String target) {
        ...
        Future<ResponseStatus> submit = pool.submit(new FutureSave(dsnWrite, checkSumService, dataset, target));
